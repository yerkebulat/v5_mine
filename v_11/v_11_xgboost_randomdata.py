...
xgb_model = XGBRegressor(n_estimators=100, max_depth=None, random_state=42)
...
plt.title("Random Data - Copper Concentration Heatmap (Predicted values) - XGBoost Regression")
plt.xlabel("X")
plt.ylabel("Y")
